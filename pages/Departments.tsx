    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center animate-in">
                <div>
                    <h2 className="text-2xl font-bold" style={{ color: '#0f172a', fontFamily: "'Outfit', sans-serif" }}>Gerenciamento de Setores</h2>
                    <p style={{ color: '#94a3b8' }} className="text-sm">Cadastro e controle de setores e centros de custo</p>
                </div>
                <button
                                ...
                                <tr key={d.id} className="table-row-hover">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            <div className="w-9 h-9 rounded-xl flex items-center justify-center text-white font-bold text-sm" style={{ background: 'linear-gradient(135deg, #4F6BFF, #3b52db)' }}>
